...
const messages = {
  'zh-CN': {
    ...
    'settings.downloadDirHint': '未命中标签映射时，下载任务默认保存到此目录。选择后需点击底部「保存更改」才会写入服务端。',
    'settings.ytDlpEngine': '引擎：yt-dlp {version} · 可执行文件 {binary}',
  ...
  'en-US': {
    ...
    'settings.downloadDirHint': 'When a download does not match any tag mapping, it is saved to this directory. After selecting, click "Save Changes" at the bottom to write to the server.',
    'settings.ytDlpEngine': 'Engine: yt-dlp {version} · Binary {binary}',
